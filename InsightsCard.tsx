        ...
        <div>
          <div className="mb-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-semibold text-gray-700">Goal Achievement</h3>
            </div>
              ...
              {analysis.achievable ? (
                ...
                <div className="space-y-2">
                  <p className="text-amber-600">
                    At current rate, you'll achieve FIRE by age {analysis.actualRetirementAge}
                  </p>
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-semibold text-gray-700">Current Metrics</h3>
            </div>
            <div className="bg-gray-50 rounded-lg p-4">
              <p className="text-gray-600">
